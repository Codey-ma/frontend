...
const Signup = () => {
  return (
    <div className="overflow-hidden bg-white flex flex-row w-full pt-2 px-4" id="signupContainer">
      ...
      <div className="flex flex-row gap-20 items-center mx-60" id="signup">
        <div className="flex flex-row mt-60 gap-5 w-3/5 items-center">
          <div className="flex flex-col gap-12 w-1/2">
            ...
            <div className="text-4xl font-medium">Become A Youth Coder</div>
            <br />
            <div>
        ...
        <div>
          <img src={Saly} className="self-end relative mt-16" id="Saly" alt="Saly" />
        </div>
        <div className="flex flex-col gap-4 items-center" id="signup-form">
          <div className="text-3xl font-medium mb-3">Sign Up</div>
          <div className="">
            <input type="text" className="Text-sm" placeholder="Enter email" />
          </div>
          <div className="">
            <input type="text" className="Text-sm" placeholder="Create Username" />
          </div>
          <div className="">
            <input type="number" className="Text-sm" placeholder="Contact number" />
          </div>
          <div className="">
          ...
          <div className="font-medium text-[#b5b5b5] self-center mb-6">or continue with</div>
